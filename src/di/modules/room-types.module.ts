...
import { RoomTypesController } from '~/interface-adapters/controllers/room-types.controller';
...
export function createRoomTypesModule() {
  ...
  roomTypesModule
    .bind(DI_SYMBOLS.IRoomTypesController)
    .toClass(RoomTypesController, [DI_SYMBOLS.IGetRoomTypesUseCase]);
